...
class ConfirmRumahPage extends StatelessWidget {
  const ConfirmRumahPage({super.key, required this.picture});
                      ...
                      child: CustomPrimaryButton(
                          ...
                          onPressed: () {
                            context
                                ...
                                .getPhotoRumahFile(file: picture);
                            Navigator.popAndPushNamed(context, 'tambah-suara');
                          }))
                ],
              ),
            ),
